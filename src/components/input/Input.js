    ...
    <div className="relative">
      <input
        ...
        className={classNames(
          "w-full px-6 py-4 text-sm font-medium border rounded-xl text-text1 dark:text-white dark:placeholder:text-text2 placeholder:text-text4 placeholder:font-medium bg-transparent",
          error.length > 0
